...
const fastcapHighlighter = createHighlighter({
  languages: [fastcapFenceLanguage, fastcapYueLanguage, json, toml],
})
...
function HighlightedTokens(props: { tokens: Array<HighlightToken> }) {
  return (
    <>
